...
<head>
    ...
    <link rel="dns-prefetch" href="//www.21cnjy.com">
    <link rel="dns-prefetch" href="//www.jbzyk.com">
    <link rel="dns-prefetch" href="//news.jbzyk.com">
    <link rel="dns-prefetch" href="//tikupic.21cnjy.com">
    <link rel="dns-prefetch" href="//www.kt5u.com">
    <link rel="icon" href="//www.21cnjy.com/favicon.ico" mce_href="//www.21cnjy.com/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="/static/css/login.min.css?v=1c04eaf3b6">    <style>html, body { height: 100%; }</style>
</head>
<style type="text/css">
...
.login-method--weixin .info { font-size: 14px; color: #999; line-break: 24px; padding-top: 16px; }
...
.login-method__tab--wx .img { background: url(/static/images/tab-weixin.png) no-repeat left top; }
.login-method__tab--ac .img { background: url(/static/images/tab-account.png) no-repeat left top; }
...
.login-method__tab--wx .tip i { background: url(/static/images/ico-qrcode.png) no-repeat left top; }
.login-method__tab--ac .tip i { background: url(/static/images/ico-pass.png) no-repeat left top; }
...
<body>
    ...
    <div class="bg-global"  id="loginForm" style="display:block">
        <div class="bg-login">
            <div class="img-wrap">
                <img src="/static/images/register/login-logo.png" alt="21教育">
            </div>

            <form class="my-form J_LoginTabContent" action="/login?jump_url=https%3A%2F%2Fzujuan.21cnjy.com%2F" method="post">
<input type="hidden" name="_csrf" value="0gg6KQAQIT5WlN2y-FiBiM-_mNu0wKgujH8LKM1vXKi9TmpeYkpPejjk7ICnLN6wo_TyssT46UPWNXMFiAEx7g==">
                

                <div class="login-tips" id="login-tips">&nbsp;</div>
                <div class="user-input user-input1">
                    <label class="ie-placeholder" for="user-name">手机/邮箱/用户名</label>
                    <input type="text" name="LoginForm[username]" placeholder="手机/邮箱/用户名" id="user-name">
                </div>
                <div class="user-input">
                    <label class="ie-placeholder" for="user-pwd">请输入密码</label>
                    <input type="password" name="LoginForm[password]" placeholder="请输入密码" id="user-pwd">
                </div>
                ...
                <p class="pwd f-usn" onselectstart="return false">
                    ...
                    <a href="/site/password-find?jump_url=https%3A%2F%2Fzujuan.21cnjy.com%2F">忘记密码</a>
                </p>
                <button class="btn" type="submit">登录</button>
                <div class="oth-login"><p>选择其他方式登录</p></div>
                
                <div class="oth-qq">
                        <a href="/site/show-qr-code?jump_url=https%3A%2F%2Fzujuan.21cnjy.com%2F" target="_blank"; style="text-decoration:none;" class="weixin-btn"> </a>
                    <a href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=310510134&redirect_uri=https://21cnjy.com/connect.php&state=https://zujuan.21cnjy.com/&scope=get_user_info" class="qq-btn"> </a>
                </div>
                <div class="register">还没有账号？注册一个吧！<a href="/register?jump_url=https%3A%2F%2Fzujuan.21cnjy.com%2F">立即注册</a></div>
            </form>
            ...
            <div class="address">
                <p><span> 深圳市龙岗区横岗街道深峰路3号启航商务大厦5楼</span> <span>邮编：518000</span> <span>电话：4006379991</span></p>
                <p>2006-2017 版权所有©深圳市二一教育股份有限公司 <a href="http://www.miitbeian.gov.cn/" rel="nofollow" target="_blank">粤ICP备11039084</a> 粤教信息(2013)2号</p>
            </div>
    ...
    <div class="bg-global" id="bindForm" style="display:none">
        <div class="bg-login" id="j-co-bind">
            ...
            <div class="login-form" id="j-yes" >
                <form class="my-form-bind" action="/login?jump_url=https%3A%2F%2Fzujuan.21cnjy.com%2F" method="post">
<input type="hidden" name="_csrf" value="0gg6KQAQIT5WlN2y-FiBiM-_mNu0wKgujH8LKM1vXKi9TmpeYkpPejjk7ICnLN6wo_TyssT46UPWNXMFiAEx7g==">                    <div class="user-input user-input1">
                        <label class="ie-placeholder" for="user-account">请输入手机</label>
                        <input type="text" name="mobile" class="require-input" placeholder="请输入绑定的手机" >
                        <input type="hidden" name="jump_url" value="https://zujuan.21cnjy.com/">
                    </div>

                    <div class="user-input user-input1">
                        <label class="ie-placeholder" for="user-Code">请输入图形验证码</label>
    ...
    <div class="bg-global" id="show" style="display:none">
        <div class="bg-login hwrap">
            ...
            <div class="login-form" id="j-yes" >
                <form class="my-form-bind" action="/login?jump_url=https%3A%2F%2Fzujuan.21cnjy.com%2F" method="post">
<input type="hidden" name="_csrf" value="0gg6KQAQIT5WlN2y-FiBiM-_mNu0wKgujH8LKM1vXKi9TmpeYkpPejjk7ICnLN6wo_TyssT46UPWNXMFiAEx7g==">                <a  href='https://zujuan.21cnjy.com/' class="btn1" >完成认证 </a>
                </form>            </div>
    ...
    <script src="//static.21cnjy.com/js/jquery-1.9.1.min.js"></script>
    <script src="//static.21cnjy.com/layer/3.0.1/layer.js"></script>

    <script src="/static/js/common.min.js?v=b205ecaa9d"></script>    <script src="/static/js/login.min.js?v=96bf2194d9"></script>    <script src="/static/js/mobile-bind.min.js?v=237243b917"></script>    <script>
        var opt = { }
        var login_form = new LoginForm('form.my-form').init(opt);
    </script>
    <script>
        document.domain = '21cnjy.com';
        var enable = false;
        var t = null;
        $('.J_LoginTab').on('click', '.tab', function(evt) {
            ...
            if (_i == 1) {
                // 微信方式
                enable = true;
                $.get('/site/show-qr-code', {jump_url: 'https://zujuan.21cnjy.com/'}).then(function(res) {
        ...
        function fetch2(ticket) {
            ...
            var check_url = "/site/issubscribe"+'?ticket='+ticket+"&jump_url=https://zujuan.21cnjy.com/&r="+Math.random();
            $.getJSON(check_url).done(function(data) {
                if(data.code == 1) {
                    window.location.href = 'https://passport.21cnjy.com/wxlogin?ticket='+ticket+"&jump_url=https://zujuan.21cnjy.com/";
                }
                else {
                    fetch(ticket);
                }
